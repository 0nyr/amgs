...
public class Screen { 
    ...
    public void renderBullet(int xp, int yp, Sprite sprite) {
    ...
    public void renderAstero(int xp, int yp, Sprite sprite) {
    ...
    public void renderHeart(int xp, int yp, Sprite sprite) {
