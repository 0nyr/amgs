...
public class AMGS extends Canvas implements Runnable {
	...
	private BufferedImage image=new BufferedImage(WIDTH,HEIGHT,BufferedImage.TYPE_INT_RGB);//On instancie une Buffered image
	...
	public void Render() {//checked
		...
		for (int y=0; y<screen.height;y++) {
			for(int x=0;x<screen.width;x++) {
				...
				if(colourcode<255)pixels[x+y*WIDTH]=colours[colourcode];//pourquoi
